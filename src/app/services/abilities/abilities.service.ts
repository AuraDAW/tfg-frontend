...
export class AbilitiesService {
  ...
  getAbilities(): Observable<Ability[]> {
    return this.http
      .get<Ability[]>(`${this.url}/abilities`)
  ...
  getAbility(id: number): Observable<Ability[]> {
    return this.http
      .get<Ability[]>(`${this.url}/abilities/${id}`)
      .pipe(catchError(this.handleError));
  }

  getPokemonAbilities(id: number): Observable<Ability[]> {
    return this.http
      .get<Ability[]>(`${this.url}/abilities/pokemonAbilities/${id}`)
      .pipe(catchError(this.handleError));
  }
  ...
  postAbility(ability: Ability): Observable<{ id: Number }> {
    ...
    return this.http
      .post<{ id: Number }>(`${this.url}/abilities`, ability, { headers })
      .pipe(catchError(this.handleError));
  }
  ...
  deleteAbility(id: Number): Observable<{ message: string }> {
    return this.http
      .delete<{ message: string }>(`${this.url}/abilities/${id}`)
      .pipe(catchError(this.handleError));
  }
